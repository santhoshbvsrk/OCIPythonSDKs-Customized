...
import InputData_Block_Boot_VM
import time
import oci
...
create_boot_volume_response = core_client.create_boot_volume(
    create_boot_volume_details=CreateBootVolumeDetails(
        compartment_id=InputData_Block_Boot_VM.compartment_id,
        source_details=BootVolumeSourceFromBootVolumeDetails(
            id = InputData_Block_Boot_VM.boot_vol_replica_id,
            type= InputData_Block_Boot_VM.create_boot_type),
        availability_domain=InputData_Block_Boot_VM.availability_domain,
        display_name=InputData_Block_Boot_VM.boot_vol_name,
        size_in_gbs=InputData_Block_Boot_VM.boot_vol_size_in_gbs,
        vpus_per_gb=InputData_Block_Boot_VM.boot_vol_vpus_per_gb,
        is_auto_tune_enabled=InputData_Block_Boot_VM.is_auto_tune_enabled,
        boot_volume_replicas=[
            oci.core.models.BootVolumeReplicaDetails(
                availability_domain=InputData_Block_Boot_VM.bootvolreplica_availability_domain,
                display_name=InputData_Block_Boot_VM.bootvolreplica_name)]
        )
)
...
# Create VNIC Details
vnic_details = CreateVnicDetails(subnet_id=InputData_Block_Boot_VM.subnet_id, assign_public_ip=InputData_Block_Boot_VM.vm_assign_public_ip,private_ip=InputData_Block_Boot_VM.vm_private_ip)
...
instance_details = LaunchInstanceDetails(
    availability_domain=InputData_Block_Boot_VM.availability_domain,
    compartment_id=InputData_Block_Boot_VM.compartment_id,
    display_name=InputData_Block_Boot_VM.vm_display_name,
    image_id=get_boot_response.image_id,
    shape=InputData_Block_Boot_VM.vm_shape,
    shape_config=LaunchInstanceShapeConfigDetails(
            ocpus=InputData_Block_Boot_VM.vm_ocpus,
            memory_in_gbs=InputData_Block_Boot_VM.vm_memory_in_gbs),
...
blkvolocid = InputData_Block_Boot_VM.block_vol_replica_ocid
    ...
    create_volume_response = core_client.create_volume(
        ...
        block_volume_replicas=[
            BlockVolumeReplicaDetails(
                availability_domain=InputData_Block_Boot_VM.blockvolreplica_availability_domain,
